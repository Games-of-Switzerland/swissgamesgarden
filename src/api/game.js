...
export const getGame = async (key, field_path) => {
  const queryUrl = query({
    ...
    fields: {
      'node--game':
        'title,body,genres,studios,genres,releases_normalized,release_platforms,website,locations,publishers,sponsors,social_networks,languages,awards,credits,completeness,members,images,contextual_links,sources',
      studios: 'title',
      'node--studio': 'title',
      'node--people': 'title',
